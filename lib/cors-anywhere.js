...
/**
 * Adds IFRAME headers to the response headers.
 *
 * @param headers {object} Response headers
 * @param request {ServerRequest}
 */
function withIFRAME(headers, request) {
  headers['X-Frame-Options'] = '*';
  if (request.headers['X-Frame-Options']) {
    headers['X-Frame-Options'] = request.headers['X-Frame-Options'];
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  withIFRAME(response.headers, req);
